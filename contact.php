            ...
            <div id="contactCards">
                <div class="contactCard">
                    <ul class="cardElementList">
                        <li class="contactName"><span class="contactInfo">John Smith</span></</li>
                        <li class="contactTitle"><span class="contactInfo">CEO and Owner</span></li>
                        <li class="contactPhone"><span class="contactInfo">801*555*5555</span></li>
                        <li class="contactEmail"><span class="contactInfo">John.Smith@example.com</span></li>
                        <li class="description" id="contactDescription">Owner and CEO. Manages all contact info. Here to satisfy your needs. bla bla</li>
                    </ul>
                </div>
            </div>
        </div>
